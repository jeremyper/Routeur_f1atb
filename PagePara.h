...
<div class="rowh"><label for="MQTTSecure">Connexion chiffrée (TLS)<span class="hint">Obligatoire pour un broker distant — port 8883. À laisser désactivé pour un serveur local.</span></label><label class="sw"><input type="checkbox" id="MQTTSecure" name="MQTTSecure" onclick="PortSelonTLS();"><span class="kn"></span></label></div>
