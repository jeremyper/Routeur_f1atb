...
void LectureShellyProEm() {
  ...
  if (Shelly_Name.indexOf("shellypro3em")==0 && voie == 3) { //pour shellypro3em et shellypro3em63
    ...
    Tension_M1 = ValJson("a_voltage", tmp);
    Intensite_M1= ValJson("a_current", tmp);
    pf1 = ValJson("a_pf", tmp);

    Tension_M2 = ValJson("b_voltage", tmp);
    Intensite_M2= ValJson("b_current", tmp);
    pf2 = ValJson("b_pf", tmp);

    Tension_M3 = ValJson("c_voltage", tmp);
    Intensite_M3= ValJson("c_current", tmp);
